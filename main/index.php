...
<body>
  <main>
    <div class="container">
      <img class="header-img" src="../media/pexels-the-lazy-artist-gallery-1262352.jpg" alt="Snow" style="width:100%;">
      <div class="top-center">
        <div class="header">
          ...
          <a href="index.php"><img class="Header-Logo" src="../media/BookAndGoLogo.png" alt="Logo bookandgo"></a>
    ...
    <div class="ContainerContext "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#f3e5d8" fill-opacity="1" d="M0,96L48,90.7C96,85,192,75,288,106.7C384,139,480,213,576,229.3C672,245,768,203,864,165.3C960,128,1056,96,1152,101.3C1248,107,1344,149,1392,170.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
      </svg>
